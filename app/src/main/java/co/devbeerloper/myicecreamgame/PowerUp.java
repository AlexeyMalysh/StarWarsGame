...
public class PowerUp {
    ...
    public PowerUp(Context context, float screenWidth, float screenHeigth) {
        speed = 6;
        positionX = screenWidth;
        spriteSizeHeigth = 100;
        spriteSizeWidth = 100;
        positionY = random.nextInt((int) screenHeigth - spriteSizeHeigth - 100) + 100;
        //Getting bitmap from resource
        Bitmap originalBitmap = BitmapFactory.decodeResource(context.getResources(),R.drawable.gold);
